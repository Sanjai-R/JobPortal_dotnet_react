...
namespace JOB_PORTAL_WEBAPP.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        public CategoryController(JobPortalContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CategoryModel>> PostCategoryModel(CategoryModel categoryModel)
        {
            ...
            return CreatedAtAction("GetCategoryModel", new { id = categoryModel.CatID }, categoryModel);
        }
